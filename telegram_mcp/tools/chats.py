...
from telethon.tl.types import Channel, Chat, InputPeerChat, User
...
from telegram_mcp.forum_requests import (
    CreateForumTopicRequest as CreateForumTopicRequest,
    GetForumTopicsRequest as GetForumTopicsRequest,
)
